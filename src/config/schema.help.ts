...
export const FIELD_HELP: Record<string, string> = {
  ...
  "agents.defaults.gateway":
    'LLM execution gateway selection: "pi" uses the @mariozechner/pi-* stack (default, stable), "mastra" uses the Mastra v1.8.0 adapter layer (experimental). Switch to "mastra" to opt into the new gateway; revert to "pi" to fall back. No session file migration is required.',
